...
fields:
    body:
        ...
        meta:
            default: ""
            placeholder: sample.getsamplerequest.body.placeholder
            hint: ""
            label: sample.getsamplerequest.body.label
            options:
                flags: []
                list: []
            readonly: false
    ...
    smp:
        ...
        meta:
            default: ""
            placeholder: sample.getsamplerequest.smp.placeholder
            hint: ""
            label: sample.getsamplerequest.smp.label
            options:
                flags: []
                list: []
            readonly: false
